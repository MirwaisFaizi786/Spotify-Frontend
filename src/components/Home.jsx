  ...
  return (
    <div className="flex flex-col justify-center items-center mt-4">
      <div className="flex gap-4 mb-5">
        <button className="text-white bg-gray-400 py-2 px-3 rounded-md hover:bg-gray-500 hover:text-black ">4 weeks</button>
        <button className="text-white bg-gray-400 py-2 px-3 rounded-md">6 months</button>
        <button className="text-white bg-gray-400 py-2 px-3 rounded-md">last year</button>
        <button className="text-white bg-gray-400 py-2 px-3 rounded-md">all time</button>
      </div>
